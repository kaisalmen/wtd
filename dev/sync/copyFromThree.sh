...
cp -fv ${DIR_THREE}/examples/jsm/loaders/workerTaskManager/worker/tmOBJLoader.js ${DIR_BASE}/public/examples/worker/tmOBJLoader.js
...
cp -fv ${DIR_THREE}/examples/models/obj/female02/female02_vertex_colors.obj ${DIR_BASE}/public/examples/models/female02_vertex_colors.obj
